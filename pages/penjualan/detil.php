...
<div>
    <div class="bg-body-tertiary p-5 rounded">
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <input type="hidden" name="kodetrans" id="kodetrans" readonly value="<?php echo $trans; ?>">

                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h2 class="mb-0"><i class="bi bi-cart-plus"></i> Tambah Penjualan</h2>
                    <a href="index.php?menu=penjualan" class="btn btn-secondary">
                ...
                <div>
                    <div class="row g-3">
                        <div class="col-md-3">
                            ...
                            <input type="date" name="tanggal" id="tanggal" class="form-control" required value="<?php echo $curdate ?>">
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="card border-light-subtle mb-4">
                        <div class="card-body">
                            <div class="row g-3 align-items-end">
                                ...
                                <div class="col-md-1">
                                    <button type="button" id="tambah" class="btn btn-success w-100" onclick="simpan()">
                        ...
                        <div class="col-md-6 offset-md-6">
                            <table class="table table-bordered align-middle mb-0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" id="diskon" value="0" class="form-control" min="0" max="100" oninput="hitungPembayaran()">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" id="bayar" class="form-control" min="0" oninput="hitungPembayaran()">
                                    </td>
                                </tr>
                                <tr>
                    ...
                    <div class="text-end mt-3">
                        <a href="index.php?menu=penjualan" type="button" name="simpan_penjualan" class="btn btn-success btn-lg">
